<x-layouts.public title="Sobre nosotros" description="Conoce a {{ $settings->company_name }}: profesionales de las bombas de agua con años de experiencia.">
    <section class="bg-slate-50 border-b border-slate-100">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
            ...
            <p class="mt-3 max-w-2xl text-lg text-slate-600">{{ $settings->tagline }}</p>
        </div>
    </section>
    ...
    <section class="py-16">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose prose-slate">
            <p class="text-lg text-slate-700 leading-relaxed">
                En <strong>{{ $settings->company_name }}</strong> llevamos desde {{ $settings->founded_year }} ofreciendo
            ...
            <p class="mt-6 text-slate-700 leading-relaxed">
                ...
                {{ implode(', ', $settings->service_areas) }}. Nuestro objetivo es que nunca te falte el suministro
    ...
    <section class="bg-sky-700">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 text-center">
            ...
            <p class="mt-3 text-sky-100">Estamos disponibles {{ $settings->schedule }}.</p>
